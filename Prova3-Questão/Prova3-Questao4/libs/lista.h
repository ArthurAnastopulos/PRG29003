...
namespace prglib {
    ...
    public:
        ...
        //Incompleto-> construtor para popular a lista com os dados contidos na stream "inp" (ela pode ser um arquivo)
        ...
        // adiciona uma lista de "dados" no final da lista;
        ...
        // remove todos os dados apartir de uma "posição" na lista (inclusive ela);
        //retorna a quantidade de dados removidos;
        ...
        // ordena a lista -> usa OrdernaSelection();
        void ordena();
    ...
    private:
        ...
        struct Nodo {
            ...
            //desconecta este nodo de seu nodo antecessor e sucessor;
            void desconecta() {
