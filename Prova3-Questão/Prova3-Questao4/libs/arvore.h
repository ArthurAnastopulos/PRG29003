...
namespace prglib {
    ...
    public:
        ...
        // Iteração da árvore (pre-order)
        void inicia();
        bool fim();
        T& proximo();

        // iteração reversa da árvore (pre-order)
        void iniciaPeloFim();
        bool inicio();
        T& anterior();
        ...
        //Obtem todas as folhas de uma arvore;
        void obtem_folhas(lista<T> & result);
